...
class MenuItemsService {
    constructor(props) {
        if (process.env.REACT_APP_NODE_ENV === 'production') {
            this.ORDERS_API_URL = 'https://iosr2017menu-production.herokuapp.com/v1/menu/items';
        } else if (process.env.REACT_APP_NODE_ENV === 'staging') {
            this.ORDERS_API_URL = 'https://iosr2017menu-staging.herokuapp.com/v1/menu/items';
        } else {
